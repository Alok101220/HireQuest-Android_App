...
class DateAdapter(private val context: Context, private val months: List<String>) : RecyclerView.Adapter<DateAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (position == selectedItem) {
            ...
            holder.itemView.background=ContextCompat.getDrawable(context,R.drawable.rounded_background)

...
class UserProfileAdapter(
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val userProfileImg = itemView.findViewById<ImageView>(R.id.search_user_profile_picture)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        if (holder is ViewHolder) {
            ...
            holder.currentOccupation.text = userProfile.user.currentOccupation
            holder.headline.text = userProfile.user.headline
            holder.name.text = userProfile.user.name
